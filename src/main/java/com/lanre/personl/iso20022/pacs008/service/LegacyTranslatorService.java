...
public class LegacyTranslatorService {
    ...
    public MxPacs00800110 translateMT103ToPacs008(String mt103Message) {
        try (LoggingContext.Scope ignored = LoggingContext.withEndToEndId(extractEndToEndId(mt103Message))) {
            ...
            try (LoggingContext.Scope identifiers = LoggingContext.withIdentifiers(grpHdr.getMsgId(), extractEndToEndId(mt103Message))) {
                ...
                if (f32A != null) {
                    ...
                    } catch (Exception ignoredMappingFailure) {
                        // Keep translation best-effort for demo purposes.
                    }
                } else {
    ...
    private String extractEndToEndId(String mt103Message) {
        for (String line : mt103Message.split("\\r?\\n")) {
